...
**Pinned tag:** `ocr-models-v1` on this repo (`Endle/beanbeaver-core`).  
...
- `beanbeaver-android/scripts/fetch-models.sh`
- `beanbeaver/runtime/ocr_models.py` (`MODELS_RELEASE_TAG` + pinned SHA-256s)
